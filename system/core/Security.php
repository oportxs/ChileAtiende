...
class CI_Security {
	...
	public function entity_decode($str, $charset='UTF-8')
	{
			...
			(strtolower($charset) != 'utf-8'))
		{
			...
			$str = preg_replace_callback('~&#x(0*[0-9a-f]{2,5})~i', function(){return chr(hexdec("\\1"));}, $str, -1);
			return preg_replace_callback('~&#([0-9]{2,4})~', function(){return chr('\\1');}, $str, -1);
		}

		// Numeric Entities
		$str = preg_replace_callback('~&#x(0*[0-9a-f]{2,5});{0,1}~i', function(){return chr(hexdec("\\1"));}, $str, -1);
		$str = preg_replace_callback('~&#([0-9]{2,4});{0,1}~', function(){return chr('\\1');}, $str, -1);
