<div><?php $this->load->view('portada/emprendete/slides/' . $slide); ?></div>

<?php if (isset($slide) && !($slide == "etapas" || $slide == "apoyos")): ?>
    <!-- FICHAS DESTACADAS -->
    ...
    <div id="general">
        ...
        <div class="portada_box">
            ...
            <ul>
                ...
                <li><a href="#" target="_blank">Red de Apoyo</a></li>
                <li><a href="#" target="_blank">Manual del Emprendimiento</a></li>
            </ul>
        </div>
    </div>
