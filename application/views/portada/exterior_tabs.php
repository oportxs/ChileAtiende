...
<div class="contenedor-principal">	
	...
	<div class="row-fluid">
		<div class="span12 titulos-accesos visible-desktop">
			<div class="span6">
				<h3>¿Por qué estás en el extranjero?</h3>
			</div>
			<!--
			<div class="span3">
		...
		<div class="span12 nav-principal">
			<div class="span2" data-id="">
				<h3><a class="etapa-id" data-val="1" href="#">Tengo residencia permanente</a></h3>
			</div>
			<div class="span2" data-id="">
				<h3><a class="etapa-id" data-val="2" href="#">Tengo residencia temporal</a></h3>
			</div>
			<div class="span2" data-id="">
				<h3><a class="etapa-id" data-val="3" href="#">Estoy de viaje</a></h3>
			</div>
		</div>
