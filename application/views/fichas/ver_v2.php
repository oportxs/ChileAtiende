...
<div id="content" class="ficha<?php echo $ficha->flujo?' ficha-flujo':''; ?><?php echo $ficha->Maestro->sello_chilesinpapeleo?' ficha-sello-chilesinpapeleo':''; ?><?php echo $ficha->metaficha ? ' ficha-metaficha':''; ?>">
    ...
    <div class="row-fluid row-ficha">
        ...
        <div class="span-maincontent" id="maincontent-ficha">
                ...
                if (    ($_metaficha_show00 && !empty($ficha->guia_online)) || 
                    ...
                    <div class="canales-tramite">
                        ...
                        <ul class="nav nav-tabs no-print rs_skip" id="tabs-canales-tramite">
                            ...
                            <?php echo ($_metaficha_show01 && !empty($ficha->guia_oficina))?'<li class="oficina"><a href="#oficina" data-toggle="tab" data-ga-te-category="Acciones Ficha" data-ga-te-action="Tab Oficina" data-ga-te-value="'.$ficha->maestro_id.'">En oficina</a></li>':''; ?>
                            <?php echo ($_metaficha_show02 && !empty($ficha->guia_telefonico))?'<li class="telefonico"><a href="#telefonico" data-toggle="tab" data-ga-te-category="Acciones Ficha" data-ga-te-action="Tab Telefono" data-ga-te-value="'.$ficha->maestro_id.'">Por teléfono</a></li>':''; ?>
