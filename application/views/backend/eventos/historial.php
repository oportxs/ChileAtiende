<div class="breadcrumb">
    ...
    <span>Historial: <?= $evento->titulo ?></span>
</div>

<div class="pane">
    <?php $this->load->view('backend/eventos/menu', array('tab' => 'historial')); ?>
    <h2>Historial de versiones</h2>

    <table class="logTable">
        <?php
        $cnt = 1;
        foreach ($evento->Historiales as $l) {
            ...
            <tr>
                ...
                <td class="<?=$class?>">
                    <h3>Evento # <?= $l->evento_id ?> versión #<?= $l->evento_version_id ?></h3>
