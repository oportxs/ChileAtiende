                    ...
                    <div class="span2 visible-desktop">
                        <ul class="unstyled lista-contactos">
                            ...
                            <li class="contactos-correo">
                                <a class="hidden-phone" href="https://www.chileatiende.gob.cl/contacto/formulario.php?origen=<?php echo site_url(); ?>" data-toggle="modal-chileatiende" data-modal-type="iframe" data-ga-te-category="Menu Encabezado" data-ga-te-action="clic" data-ga-te-value="Contacto">Contacto</a>
                                <a class="visible-phone" href="https://www.chileatiende.gob.cl/contacto/formulario.php?origen=<?php echo site_url(); ?>" data-ga-te-category="Menu Encabezado" data-ga-te-action="clic" data-ga-te-value="Contacto">Contacto</a>
                            </li>
